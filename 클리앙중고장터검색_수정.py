...
for n in range(0,10):
        #클리앙의 중고장터 주소 : https://www.clien.net/service/board/sold?&od=T31&category=0&po=
        ...
        list = soup.findAll('div', attrs={'class':'list_subject'})
        #list = soup.findAll('span', attrs={'class':'subject_fixed'})
